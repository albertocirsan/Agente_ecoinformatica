...
2. Formula 10 preguntas de opción múltiple con exactamente 3 opciones cada una y una sola correcta. Para que el test no sea ni muy fácil ni muy difícil:
   ...
   - Los distractores deben tener una longitud y un nivel de detalle parecidos a los de la opción correcta. Si la correcta es sistemáticamente la más larga o la más detallada, el test se puede aprobar sin saber el tema.
